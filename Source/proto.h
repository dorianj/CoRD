...
RD_BOOL rdp_connect(RDConnectionRef conn, const char *server, uint32 flags, NSString *domain, NSString *password, const char *command, const char *directory);
RD_BOOL rdp_reconnect(RDConnectionRef conn, const char *server, uint32 flags, NSString *domain, NSString *password, const char *command, const char *directory, char *cookie);
